...
//    int count = self.emotionManagers.count / (10 * 2);
//    
//    int pageCount = (count + ((self.emotionManagers.count-count )% (10 * 2) ? 1 : 0));
//    [self.sectionBarScrollView setContentSize:CGSizeMake(ScreenWidth*pageCount, CGRectGetHeight(self.bounds))];
